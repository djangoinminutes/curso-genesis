...
# Reporte nuevo
    ...
    for aplicacion in Aplicacion.objects.filter(proyecto=proyecto):
        ...
        if aplicacion.nombre != 'core' and aplicacion.nombre != 'registration':# and aplicacion.nombre == 'generales':
            ...
            for modelo in Modelo.objects.filter(aplicacion=aplicacion):
                for propiedad in Propiedad.objects.filter(modelo=modelo):
                    if propiedad.tipo == 'f':
                        modelo_foraneo = Modelo.objects.get(nombre=propiedad.foranea,proyecto=proyecto)
                        print('modelo foraneo ',modelo_foraneo)
        ...
        if AplicacionTienePropiedades(aplicacion):
            ...
            print('aplicacion',aplicacion.nombre)
...
# Crear los archivos js
    ...
    print('alto',proyecto.altocolumnabumederecha)
                            ...
                            for propiedad in Propiedad.objects.filter(modelo=modelo):
                                ...
                                if propiedad.enlista:
                                    ...
                                    if propiedad.enmobile:
                                        ...
                                        strlt += '<!-- #@[p_modelo_list_' + propiedad.nombre + '_' + str(num) + '] -->' + '\n'
                                        num += 1
                                        strlt += '\t\t\t<div class="col-12 d-none col-md-@numerocolumnas d-flex @justificaciontextocolumna align-self-center @uppercase columna-@nombrecolumnapropiedad">' + '\n'
                                        strlt += '<!-- #@[p_modelo_list_' + propiedad.nombre + '_' + str(num) + '] -->' + '\n'
                                        num += 1
            ...
            for modelo in Modelo.objects.filter(aplicacion=aplicacion):
                if modelo.sinbasedatos == False:
                    ...
                    for modelohijo in Modelo.objects.filter(padre=modelo.nombre , proyecto = proyecto):
                        ...
                        strlh += '\t\t\t\t\t\t\t<div class="col-1 mt-1 edita-@hijo">' + '\n'
                        strlh += "<!-- #@[p_hijo_@hijo_24] -->" + "\n"
                        strlh += '\t\t\t\t\t\t\t\t@editahijo' + '\n'
                        strlh += "<!-- #@[p_hijo_@hijo_25] -->" + "\n"
                        strlh += '\t\t\t\t\t\t\t</div>' + '\n'
                        strlh += "<!-- #@[p_hijo_@hijo_26] -->" + "\n"
                        strlh += '\t\t\t\t\t\t\t<div class="col-1 ml-2 mt-1 borra-@hijo">' + '\n'
                        ...
                        if modelohijo.padre != 'nada': # modelo hijo o nieto
                            ...
                            if modelo_padre.padre != 'nada': # modelo nieto
                                modelo_abuelo = Modelo.objects.get(nombre=modelo_padre.padre , proyecto=proyecto)
                                streh += '<a class="editar-borrar-lista-@hijo" href="{% url ' + "'" + '@aplicacionhijo:editar_@hijo' + "'" + ' objeto.id %}?@modelopadre_id={{ @modelopadre_id }}&@modeloabuelo_id={{@modeloabuelo_id}}">@textoeditar</a>' + '\n'
                                strbh += '<a class="editar-borrar-lista-@hijo" href="{% url ' + "'" + '@aplicacionhijo:borrar_@hijo' + "'" + ' objeto.id %}?@modelopadre_id={{ @modelopadre_id }}&@modeloabuelo_id={{@modeloabuelo_id}}">@textoborrar</a>' + '\n'
                                streh = streh.replace('@modeloabuelo', modelo_abuelo.nombre)
                                strbh = strbh.replace('@modeloabuelo', modelo_abuelo.nombre)
                            else: # modelo hijo
                                streh += '<a class="editar-borrar-lista-@hijo" href="{% url ' + "'" + '@aplicacionhijo:editar_@hijo' + "'" + ' objeto.id %}?@modelopadre_id={{ @modelopadre_id }}">@textoeditar</a>' + '\n'
                                strbh += '<a class="editar-borrar-lista-@hijo" href="{% url ' + "'" + '@aplicacionhijo:borrar_@hijo' + "'" + ' objeto.id %}?@modelopadre_id={{ @modelopadre_id }}">@textoborrar</a>' + '\n'
                            ...
                            streh += '<a class="font_editar_borrar_lista_hijos_@modelo" href="{% url ' + "'" + '@aplicacionhijo:editar_@hijo' + "'" + ' objeto.id %}?@modelo_id={{ @modelo.id }}">@textoeditar</a>' + '\n'
                            strbh += '<a class="font_editar_borrar_lista_hijos_@modelo" href="{% url ' + "'" + '@aplicacionhijo:borrar_@hijo' + "'" + ' objeto.id %}?@modelo_id={{ @modelo.id }}">@textoborrar</a>' + '\n'
        ...
        for propiedad in Propiedad.objects.filter(modelo=modelo): 
            if propiedad.noestaenformulario == False:
                ...
                if propiedad.etiquetaarriba:
                    ...
                    strctl += '\t\t\t\t\t\t<div class="col-' + str(modelo.numerocolumnaslabels) + ' font-label-' + modelo.nombre + '">' + propiedad.etiqueta + '</div>' + '\n'
                    strctl += '\t\t\t\t\t\t<div class="col-' + str(modelo.numerocolumnascontroles) + '">' + '\n'
                    strctl += '\t\t\t\t\t\t\t{{form.' + propiedad.nombre + '}}' + '\n'
                    strctl += '\t\t\t\t\t\t</div>' + '\n'
                    strctl += '\t\t\t\t\t</div>' + '\n'
